...
/**
 * DeSerializer Utility Class to Deserialize the JSON Response.
 * This takes the Generic Collection Type for Deserialization.
 */
public class CollectionDeserializer implements JsonDeserializer<Collection<?>> {
    ...
    /**
     * Utility method that returns the ArrayList of Generic Type after parsing the json Object
     * @param json
     * @param type
     * @param <T>
     * @return
